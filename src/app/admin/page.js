...
import { AlertCircle, MapPin, 
  ...
  GraduationCap, Briefcase, Bell, ChevronDown, ChevronRight, LogOut, User, Menu, Database, List, LayoutGrid, Trash2, Star, Globe, LayoutTemplate
} from "lucide-react";
...
export default function AdminDashboard() {
  ...
  const [expandedMenu, setExpandedMenu] = useState("platform");
        ...
        <aside className="admin-sidebar">
          <nav className="sidebar-nav">
            ...
            <div 
              ...
              onClick={() => setExpandedMenu(expandedMenu === "platform" ? "" : "platform")}
            >
              <span>Platform Management</span>
              {expandedMenu === "platform" ? <ChevronDown size={16} /> : <ChevronRight size={16} />}
            </div>
            <div className={`sidebar-group-content ${expandedMenu === "platform" ? "expanded" : "collapsed"}`}>
              ...
              <button className={`sidebar-link ${activeTab === "teachers" ? "active" : ""}`} onClick={() => setActiveTab("teachers")}>
                <User size={20} /><span>Teachers</span>
              </button>
              <button className={`sidebar-link ${activeTab === "employers" ? "active" : ""}`} onClick={() => setActiveTab("employers")}>
                <Users size={20} /><span>Employers</span>
              </button>
              <button className={`sidebar-link ${activeTab === "institutions" ? "active" : ""}`} onClick={() => setActiveTab("institutions")}>
                <Landmark size={20} /><span>Listings</span>
              </button>
              <button className={`sidebar-link ${activeTab === "jobs" ? "active" : ""}`} onClick={() => setActiveTab("jobs")}>
                <Briefcase size={20} /><span>Job Listings</span>
              </button>
              <button className={`sidebar-link ${activeTab === "verification" ? "active" : ""}`} onClick={() => setActiveTab("verification")}>
                <Award size={20} /><span>Verification</span>
                {claims.length > 0 && <span className="tab-counter-badge warn">{claims.length}</span>}
              </button>
              <button className={`sidebar-link ${activeTab === "suggestions" ? "active" : ""}`} onClick={() => setActiveTab("suggestions")}>
                <MessageSquare size={20} /><span>User Suggestions</span>
            ...
            <div 
              className="sidebar-group-header"
              onClick={() => setExpandedMenu(expandedMenu === "growth" ? "" : "growth")}
            >
              <span>Growth & Monetization</span>
              {expandedMenu === "growth" ? <ChevronDown size={16} /> : <ChevronRight size={16} />}
            </div>
            <div className={`sidebar-group-content ${expandedMenu === "growth" ? "expanded" : "collapsed"}`}>
              <button className={`sidebar-link ${activeTab === "ads" ? "active" : ""}`} onClick={() => setActiveTab("ads")}>
                <Play size={20} /><span>Ad Manager</span>
              </button>
              <button className={`sidebar-link ${activeTab === "reports" ? "active" : ""}`} onClick={() => setActiveTab("reports")}>
                <Activity size={20} /><span>Reports & Campaigns</span>
              </button>
              <button className={`sidebar-link ${activeTab === "places_crawler" ? "active" : ""}`} onClick={() => setActiveTab("places_crawler")}>
                <Database size={20} /><span>Places Crawler</span>
              </button>
              <button className={`sidebar-link ${activeTab === "jobs_crawler" ? "active" : ""}`} onClick={() => setActiveTab("jobs_crawler")}>
                <Briefcase size={20} /><span>Jobs Crawler</span>
              </button>
            </div>
            ...
            <div 
              className="sidebar-group-header"
              onClick={() => setExpandedMenu(expandedMenu === "design" ? "" : "design")}
            >
              <span>Design & CMS</span>
              {expandedMenu === "design" ? <ChevronDown size={16} /> : <ChevronRight size={16} />}
            </div>
            <div className={`sidebar-group-content ${expandedMenu === "design" ? "expanded" : "collapsed"}`}>
